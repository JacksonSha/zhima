            ...
            <div class="primary col-md-8 col-sm-12 col-xs-12">
                <section class="about section">
                    <div class="section-inner">
                        ...
                        <div class="content">
                            <p>1990年生人，2011年毕业于苏州大学数学院，从此踏上了码农的不归路。</p>    
                    ...
                    <div class="section-inner">
                        ...
                        <div class="content">    
                            ...
                            <div class="item row">
                                ...
                                <img class="img-responsive project-image" src="${pageContext.request.contextPath}/webresource/images/projects/project-5.png" alt="project name" />
                                </a>
                            ...
                            <div class="item row">
                                ...
                                <img class="img-responsive project-image" src="${pageContext.request.contextPath}/webresource/images/projects/project-4.png" alt="project name" />
                                </a>
                                <div class="desc col-md-8 col-sm-8 col-xs-12">
                            ...
                            <div class="item row">
                                ...
                                <img class="img-responsive project-image" src="${pageContext.request.contextPath}/webresource/images/projects/project-1.png" alt="project name" />
                                </a>
                                <div class="desc col-md-8 col-sm-8 col-xs-12">
                            ...
                            <div class="item row">
                                ...
                                <img class="img-responsive project-image" src="${pageContext.request.contextPath}/webresource/images/projects/project-2.png" alt="project name" />
                                </a>
                                <div class="desc col-md-8 col-sm-8 col-xs-12">
